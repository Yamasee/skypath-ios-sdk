...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SkyPathSDK",
            url: "https://github.com/Yamasee/skypath-ios-sdk/releases/download/v3.0.13/SkyPathSDK.xcframework.zip",
            checksum: "aaa38c4a0e284e081cac7b69e64695d16b0bcb0d0edb50c151a9df0e5d2acb94"),
        .target(
