...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SkyPathSDK",
            url: "https://github.com/Yamasee/skypath-ios-sdk/releases/download/v3.0.18/SkyPathSDK.xcframework.zip",
            checksum: "6842d4f7c3d646373f78c835c00c59ab0730995dab562b91ca466e7694870788"),
        .target(
